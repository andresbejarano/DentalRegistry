...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Dental: Modificar Antecedentes</title>
		...
		<script type="text/javascript" src="javascript/modifybackground.js"></script>
	</head>
	<body>
		...
		<div id="outer-wrapper">
			<fieldset>
				...
				if($patientdata != null){
					?>
					<legend><a href="medicalrecord.php?id=<?php echo $patientdata['id'];?>">Historia Cl&iacute;nica</a> &rarr; Modificar Antecedentes: <a href="patient.php?id=<?php echo $patientdata['id'];?>"><?php echo $patientdata['firstname'] . ' ' . $patientdata['firstlastname'] . ' ' . $patientdata['secondlastname'];?></a></legend>
					<?php
					if($patientdata['active'] == 1){
						...
						<form action="#" id="medicalrecord" method="post">
							...
							<p class="form center">
								...
								<input type="button" value="Modificar Antecedentes" />
							</p>
						</form>
						<?php
					}
