...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Dental: Agregar Subprocedimiento</title>
		<link rel="shortcut icon" type="image/x-icon" href="images/favicon.ico" />
		<?php include('includes/styles.php');?>
		<?php include('includes/jquery.php');?>
		<script type="text/javascript" src="js/addsubprocedure.js"></script>
	</head>
	<body>
		<div id="header">
		...
		<div id="outer-wrapper">
			<fieldset>
				<legend>Agregar Subprocedimiento</legend>
				<form action="#">
					<p class="form">
					...
					<p class="form">
						<label for="procedure">*Vincular a Procedimiento</label>
					...
					<p class="form center">
						...
						<input type="button" value="Ingresar Nuevo Subprocedimiento" />
					</p>
				</form>
			</fieldset>
