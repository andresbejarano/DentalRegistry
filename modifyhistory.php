...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<title>Dental: Modificar Historia Cl&iacute;nica</title>
		<link rel="shortcut icon" type="image/x-icon" href="images/favicon.ico" />
		<?php include('includes/styles.php');?>
		<?php include('includes/jquery.php');?>
		<script type="text/javascript" src="js/modifyhistory.js"></script>
	</head>
	<body>
		<div id="header">
			...
			<fieldset>
				<?php
					if(isset($patientdata)){
						if($patientdata != null){
							?>
							<legend><a href="medicalrecord.php?id=<?php echo $patientdata['id'];?>">Historia Cl&iacute;nica</a> &rarr; Modificar Historia Cl&iacute;nica: <a href="patient.php?id=<?php echo $patientdata['id'];?>"><?php echo $patientdata['firstname'] . ' ' . $patientdata['firstlastname'] . ' ' . $patientdata['secondlastname'];?></a></legend>
							<?php
								...
								if($history != null){
									...
									<form action="#" id="medicalrecord" method="post">
										...
										<p class="form center">
											...
											<input type="button" value="Modificar Historia Cl&iacute;nica" />
										</p>
									</form>
									<?php
								}
						...
						?>
						<legend>Historia Cl&iacute;nica no encontrada</legend>
						<p class="center warning">La historia cl&iacute;nica solicitada no existe dentro del sistema</p>
						<?php
					}
				?>
			</fieldset>
