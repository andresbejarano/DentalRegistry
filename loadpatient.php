...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Dental: Cargar Paciente</title>
		<link rel="shortcut icon" type="image/x-icon" href="images/favicon.ico" />
		<?php include('includes/styles.php');?>
		<?php include('includes/jquery.php');?>
		<script type="text/javascript" src="js/loadpatient.js"></script>
	</head>
	<body>
		    ...
		    <fieldset>
				...
				<form action="#">
					...
					<p class="form center">
						...
						<input type="button" value="Buscar Paciente" />
					</p>
				</form>
			</fieldset>
