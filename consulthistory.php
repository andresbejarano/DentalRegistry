...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<title>Dental: Ver Historia Cl&iacute;nica</title>
			...
			<fieldset>
				<?php
					if(isset($patientdata)){
						...
						if($patientdata != null){
							?>
							<legend><a href="medicalrecord.php?id=<?php echo $patientdata['id'];?>">Historia Cl&iacute;nica</a> &rarr; Ver Historia Cl&iacute;nica: <a href="patient.php?id=<?php echo $patientdata['id'];?>"><?php echo $patientdata['firstname'] . ' ' . $patientdata['firstlastname'] . ' ' . $patientdata['secondlastname'];?></a></legend>
							<?php
