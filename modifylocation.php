...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Dental: Modificar Ubicaci&oacute;n Oral</title>
		<link rel="shortcut icon" type="image/x-icon" href="images/favicon.ico" />
		<?php include('includes/styles.php');?>
		<?php include('includes/jquery.php');?>
		<script type="text/javascript" src="js/modifylocation.js"></script>
	</head>
	<body>
		<div id="header">
		...
		<div id="outer-wrapper">
			<fieldset>
				<legend>Modificar Ubicaci&oacute;n Oral</legend>
			...
			<fieldset id="modifycontainer" style="display:none;">
				...
				<form action="#" id="modifyform">
					...
					<p class="form center">
						...
						<input id="modifybutton" type="button" value="Modificar Ubicaci&oacute;n Oral" />
					</p>
				</form>
			</fieldset>
