$(document).ready(function(){
	...
	$('#modifybutton').button().click(function(){
		...
		$.post('modules/checkproceduretypedata.php',$formdata,function(value){
			if(value == '1'){
				$.post('modules/modifyproceduretype.php',$formdata,function(data){
					if(data == '1'){
						$message.html('Tipo de procedimiento modificado satisfactoriamente');
						$message.dialog({
							title:'<img alt="success" src="images/success.png" /> Modificaci&oacute;n satisfactoria',
							buttons:{
								'Modificar Tipo de Procedimiento':function(){window.location = 'modifyproceduretype.php';},
