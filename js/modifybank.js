$(document).ready(function(){
	...
	$('#searchbutton').button().click(function(){
		...
		$('#modifycontainer').slideUp(1000,function(){
			$.post('modules/checkbank.php',$formdata,function(value){
				if(value == '1'){
					$.post('modules/getbankdata.php',$formdata,function(data){
					...
					$message.html('Los datos ingresados no corresponden a ningun banco');
					$message.dialog({
	...
	$('#modifybutton').button().click(function(){
		...
		$.post('modules/checkbankdata.php',$formdata,function(value){
			if(value == '1'){
				$.post('modules/modifybank.php',$formdata,function(data){
					if(data == '1'){
						$message.html('Banco modificado satisfactoriamente');
						$message.dialog({
							title:'<img alt="success" src="images/success.png" /> Modificaci&oacute;n satisfactoria',
							buttons:{
								'Modificar Banco':function(){window.location = 'modifybank.php';},
